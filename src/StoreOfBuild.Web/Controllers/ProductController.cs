...
namespace StoreOfBuild.Web.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            if (products.Any())
            {
                var viewModel = products.Select(p => new ProductViewModel { Id = p.Id, Name = p.Name, CategoryName = p.Category.Name });
        ...
        public IActionResult CreateOrEdit(int id)
        {
            ...
            viewModel.Categories = categories.Any() ? categories.Select(c => new CategoryViewModel {Id = c.Id, Name = c.Name }) : new List<CategoryViewModel>();
